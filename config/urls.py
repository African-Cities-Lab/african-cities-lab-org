...
urlpatterns = [ 
    ...
    #path("webinars/", TemplateView.as_view(template_name="webinars/webinars_index_page.html"), name="webinars"),
    #path("formations/", TemplateView.as_view(template_name="formations/formations_index_page.html"), name="formations"),
